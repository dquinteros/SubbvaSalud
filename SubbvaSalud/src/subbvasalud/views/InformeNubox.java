...
import subbvasalud.controllers.informeNuboxController;
 ...
 * @author damage
 */
public class InformeNubox extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public InformeNubox(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ls = new LinkedList<>();
    ...
    private void initComponents() {
        ...
        selectFile.setSelectedFile(new java.io.File("C:\\Program Files (x86)\\NetBeans 7.4\\plantilla_impotacion_comprobantes"));
                ...
                if (file.exists()) {
                    ...
                    switch (result) {
                        case JOptionPane.YES_OPTION:
                            informeNuboxController rc = new informeNuboxController();
                            rc.createNuboxReport(file, p);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformeNubox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InformeNubox dialog = new InformeNubox(new javax.swing.JFrame(), true);
