...
public class ProgressDialogCargas extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ProgressDialogCargas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[], File inputFile) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProgressDialogCargas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ProgressDialogCargas dialog = new ProgressDialogCargas(new javax.swing.JFrame(), true);
