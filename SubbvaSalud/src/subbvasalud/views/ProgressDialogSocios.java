...
public class ProgressDialogSocios extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ProgressDialogSocios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[], File inputFile) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProgressDialogSocios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ProgressDialogSocios dialog = new ProgressDialogSocios(new javax.swing.JFrame(), true);
